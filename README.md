...
Get the [latest distribution bundle](https://raw.github.com/pluma/obs/master/dist/obs.all.min.js) (~3.5 kB minified or ~1.2 kB gzipped, includes [sublish 0.4.2](https://github.com/pluma/sublish/tree/0.4.2)) and download it to your project.
...
If you are already using `sublish` in your project, you can download the [latest minified standalone release](https://raw.github.com/pluma/obs/master/dist/obs.globals.min.js) (~3.1 kB minified or ~1.1 kB gzipped) instead.
...
Try it on [jsfiddle](http://jsfiddle.net/QdLxc/4/).
